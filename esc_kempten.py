...
for time in (
    pd.date_range(start="2023-09-23T09:00", end="2024-03-30T09:00", freq="W-SAT").tolist() +
    pd.date_range(start="2023-09-28T15:45", end="2024-03-30T15:45", freq="W-THU").tolist()
):
    event = Event()
